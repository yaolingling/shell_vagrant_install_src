...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    # RackHD SERVER
    config.vm.define "dev_shell" do |target|
        ...
        target.vm.provision "shell", inline: <<-SHELL
          ...
          sudo mkdir src
          cd /vagrant && sudo /bin/bash install_src.sh /home/vagrant/src
          cd /home/vagrant/src/on-http && sudo /bin/bash install-swagger-ui.sh
          cd /home/vagrant && sudo pm2 start /home/vagrant/rackhd-pm2-config.yml 
